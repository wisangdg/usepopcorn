...
const average = (arr) => {
  if (arr.length === 0) return null; // Handle empty arrays
...
function NumResults({ movies }) {
  ...
  return <p>{movies.length} results found</p>;
}
...
// Ensure the average function is defined and handles empty arrays
  ...
  return (
    <div className="summary">
      ...
      <div>
        ...
        <p>
          <span>⏳</span>
          <span>{avgRuntime !== null ? avgRuntime : "N/A"} min</span>
        </p>
      </div>
    </div>
  );
